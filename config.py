...
LEAGUES = {
    ...
    # ESPN no publica la LPF: probe nueve codigos y los nueve dan 400. TheSportsDB
    # si la tiene (id 4819, "Panama Liga Panamena de Futbol"). Verificado el
    # 18/09/2026: 19 partidos proximos desde la jornada 9 y 15 jugados con
    # marcador, con equipos y estadios reales. Panama es el 8% de los clics.
    "liga-panama":    ("soccer", "sportsdb:4819", "LPF Panam\u00e1",  "\u26bd"),
...
POPULAR_TEAMS = {
    ...
    "navegantes-del-magallanes": {"name": "Navegantes del Magallanes", "league": "LVBP"},
    "leones-del-caracas": {"name": "Leones del Caracas", "league": "LVBP"},
    "tigres-de-aragua": {"name": "Tigres de Aragua", "league": "LVBP"},
    "cardenales-de-lara": {"name": "Cardenales de Lara", "league": "LVBP"},
    "aguilas-del-zulia": {"name": "Águilas del Zulia", "league": "LVBP"},
    "tiburones-de-la-guaira": {"name": "Tiburones de La Guaira", "league": "LVBP"},
    "caribes-de-anzoategui": {"name": "Caribes de Anzoátegui", "league": "LVBP"},
    "bravos-de-margarita": {"name": "Bravos de Margarita", "league": "LVBP"},
    # LIDOM (Liga Dominicana de Béisbol)
    "tigres-del-licey": {"name": "Tigres del Licey", "league": "LIDOM"},
    "aguilas-cibaenas": {"name": "Águilas Cibaeñas", "league": "LIDOM"},
    "leones-del-escogido": {"name": "Leones del Escogido", "league": "LIDOM"},
    "estrellas-orientales": {"name": "Estrellas Orientales", "league": "LIDOM"},
    "gigantes-del-cibao": {"name": "Gigantes del Cibao", "league": "LIDOM"},
    "toros-del-este": {"name": "Toros del Este", "league": "LIDOM"},
    # NHL
    ...
    "pecco-bagnaia": {"name": "Francesco 'Pecco' Bagnaia", "league": "MotoGP", "aka": "Pecco Bagnaia"},
    "jorge-martin": {"name": "Jorge Martín", "league": "MotoGP", "aka": "Jorge Martín"},
    "pedro-acosta": {"name": "Pedro Acosta", "league": "MotoGP", "aka": "Pedro Acosta"},
    "daniel-suarez": {"name": "Daniel Suárez", "league": "NASCAR", "aka": "Daniel Suárez"},
    "alex-palou": {"name": "Álex Palou", "league": "IndyCar", "aka": "Álex Palou"},
...
TEAM_ALIASES = {
    ...
    "red sox": "red sox",
    # LMP (Liga Mexicana del Pacífico)
    "tomateros": "tomateros de culiacan",
    "culiacan": "tomateros de culiacan",
    "naranjeros": "naranjeros de hermosillo",
    "hermosillo": "naranjeros de hermosillo",
    "yaquis": "yaquis de obregon",
    "obregon": "yaquis de obregon",
    "aguilas de mexicali": "aguilas de mexicali",
    "mexicali": "aguilas de mexicali",
    "venados": "venados de mazatlan",
    "caneros": "caneros de los mochis",
    "los mochis": "caneros de los mochis",
    "mayos": "mayos de navojoa",
    "navojoa": "mayos de navojoa",
    "algodoneros": "algodoneros de guasave",
    "guasave": "algodoneros de guasave",
    ...
    "leones de yucatan": "leones de yucatan",
    "leones": "leones de yucatan",
    "sultanes": "sultanes de monterrey",
    "sultanes de monterrey": "sultanes de monterrey",
    "acereros": "acereros de monclova",
    "monclova": "acereros de monclova",
    "pericos": "pericos de puebla",
    "pericos de puebla": "pericos de puebla",
    "olmecas": "olmecas de tabasco",
    "tabasco": "olmecas de tabasco",
    "tigres de quintana roo": "tigres de quintana roo",
    "quintana roo": "tigres de quintana roo",
    "tecolotes": "tecolotes de los dos laredos",
    "dos laredos": "tecolotes de los dos laredos",
    "toros de tijuana": "toros de tijuana",
    "bravos de leon": "bravos de leon",
    "guerreros de oaxaca": "guerreros de oaxaca",
    "oaxaca": "guerreros de oaxaca",
    "mariachis": "mariachis de guadalajara",
    "rieleros": "rieleros de aguascalientes",
    "aguascalientes": "rieleros de aguascalientes",
    ...
    "leones caracas": "leones del caracas",
    "caracas": "leones del caracas",
    "tigres aragua": "tigres de aragua",
    "cardenales lara": "cardenales de lara",
    "aguilas zulia": "aguilas del zulia",
    "tiburones": "tiburones de la guaira",
    "tiburones guaira": "tiburones de la guaira",
    "caribes": "caribes de anzoategui",
    "bravos margarita": "bravos de margarita",
    "lvbp": "lvbp",
    "beisbol venezolano": "lvbp",
    "beisbol venezuela": "lvbp",
    # LIDOM
    "licey": "tigres del licey",
    "tigres licey": "tigres del licey",
    "aguilas cibaenas": "aguilas cibaenas",
    "escogido": "leones del escogido",
    "estrellas orientales": "estrellas orientales",
    "gigantes cibao": "gigantes del cibao",
    "toros del este": "toros del este",
    "lidom": "lidom",
    ...
    "suarez nascar": "daniel suarez",
    "palou": "alex palou",
    "alex palou": "alex palou",
    "indy 500": "indycar",
    "500 millas de indianapolis": "indycar",
    "daytona 500": "nascar",
    # UFC / MMA
...
CHANNEL_ALIASES = {
    ...
    "Tubi": {"name": "Tubi", "country": "MX", "type": "streaming"},
    "FOX One MX": {"name": "Fox Sports MX", "country": "MX", "type": "cable"},
    # ── USA ──
    ...
    # ── Venezuela ──
    "Televen": {"name": "Televen", "country": "VE", "type": "broadcast"},
    "TELEVEN": {"name": "Televen", "country": "VE", "type": "broadcast"},
    "SimpleTV": {"name": "SimpleTV", "country": "VE", "type": "cable"},
    "IVC": {"name": "IVC", "country": "VE", "type": "cable"},
    "ByM Sport": {"name": "ByM Sport", "country": "VE", "type": "cable"},
    "DirecTV Venezuela": {"name": "DirecTV", "country": "VE", "type": "cable"},
    ...
    "CDN Deportes": {"name": "CDN Deportes", "country": "DO", "type": "cable"},
    "CDN": {"name": "CDN Deportes", "country": "DO", "type": "cable"},
    "Teleantillas": {"name": "Teleantillas", "country": "DO", "type": "broadcast"},
    "Coral 39": {"name": "Coral 39", "country": "DO", "type": "broadcast"},
    "Digital 15": {"name": "Digital 15", "country": "DO", "type": "broadcast"},
    "VTV Canal 32": {"name": "VTV Canal 32", "country": "DO", "type": "broadcast"},
    "Teleuniverso": {"name": "Teleuniverso", "country": "DO", "type": "broadcast"},
    "Telenord": {"name": "Telenord", "country": "DO", "type": "broadcast"},
    "SportsMax": {"name": "SportsMax", "country": "DO", "type": "cable"},
    "Claro TV+ DO": {"name": "Claro TV+", "country": "DO", "type": "cable"},
    "Altice DO": {"name": "Altice", "country": "DO", "type": "cable"},
    "ESPN Caribe": {"name": "ESPN Caribe", "country": "DO", "type": "cable"},
    # ── Panamá ──
    "TVN": {"name": "TVN Panamá", "country": "PA", "type": "broadcast"},
    "TVN Panamá": {"name": "TVN Panamá", "country": "PA", "type": "broadcast"},
    "TVMax": {"name": "TVMax", "country": "PA", "type": "broadcast"},
    "RPC": {"name": "RPC", "country": "PA", "type": "broadcast"},
    "RPC TV": {"name": "RPC", "country": "PA", "type": "broadcast"},
    "Tigo Sports": {"name": "Tigo Sports", "country": "PA", "type": "cable"},
    "Tigo Sports PA": {"name": "Tigo Sports", "country": "PA", "type": "cable"},
    "MedcomGO": {"name": "MedcomGO", "country": "PA", "type": "streaming"},
    "TVN Pass": {"name": "TVN Pass", "country": "PA", "type": "streaming"},
    "Cable Onda": {"name": "Cable Onda", "country": "PA", "type": "cable"},
    "ESPN Panamá": {"name": "ESPN", "country": "PA", "type": "cable"},
    # ── LATAM general (available in VE/DO/PA and others) ──
    "ESPN LATAM": {"name": "ESPN LATAM", "country": "LATAM", "type": "cable"},
    "Star+": {"name": "Star+", "country": "LATAM", "type": "streaming"},
